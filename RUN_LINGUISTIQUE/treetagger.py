...
class TreeTagger(TaggerI):
    def __init__(self, treetagger_languages=None,path_to_home=None,treetagger_paths=[], language='german', 
        ...
        try:
            if encoding in treetagger_languages.keys() and language in treetagger_languages[encoding]:
